...
result.innerHTML = "小孩甩開貼紙，還是繼續哭。";
    ...
    if (!momUnderstand) {    
      result.innerHTML = '旁邊的媽媽生氣了，說你為什麼對我小孩這麼兇，就抱著小孩離開，然後在google map 上留下一顆星評價說這家的牙醫很兇。';
    } else {  
...
result.innerHTML = '媽媽生氣地說醫生你到底要不要治療我的小孩，然後抱著小孩離開，在Google Maps上留下了一顆星評價，說這家牙醫很沒用不會看小孩。';
count3 = 0;
}
}
});